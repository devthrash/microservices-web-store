...
config.mongoConnectionString = process.env.MONGO_CONNECTION_STRING || 'mongodb://customers_db_user:ps@localhost/customers_db'
...
config.appPort = process.env.APP_PORT || 9003
